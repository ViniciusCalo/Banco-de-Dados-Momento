...
/*Inserindo as ocupações do departamento de inovações*/
INSERT INTO ocupacoes(ocupacao_id,ocupacao_title,min_salario,max_salario) VALUES (20,'Programador',4000.00,9000.00);
INSERT INTO ocupacoes(ocupacao_id,ocupacao_title,min_salario,max_salario) VALUES (21,'Gerente de Inovações',4000.00,11000.00);
...
/*Inserindo o novo departamento de inovações*/
INSERT INTO departamento(departamento_id,departamento_name,posicao_id) VALUES (12, 'Inovações', 5400);

/*Inserindo o meu proprio departamento*/
INSERT INTO departamento(departamento_id, departamento_name, posicao_id) VALUES (13, 'Analise de Dados', 1800);
...
/*Inserindo meus dados no departamento de tecnologia*/
...
VALUES (207, 'Vinicius', 'Calo', 'vinicius.calo@momento.org','519.334.9795', '2003-12-10',9,8000.00,NULL,6);

/*Inserindo meus amigos do demoDay no departamento de administração*/
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (208, 'Isabella', 'Rosseto', 'isabella.rosseto@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (209, 'Victor', 'Magalhaes', 'vhm.silva@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (210, 'Jeniiffer', 'Carmo', 'jeni.carmo@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id)
 VALUES (211, 'Diogo', 'Barbosa', 'diogo.barbosa@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (212, 'Joao', 'Rebelo', 'joaomarcos.rebelo@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (213, 'Rodrigo', 'Salles', 'rodrigo.sales@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (214, 'Guilherme', 'Mascarenhas', 'gui.mascarenhas@momento.org','123.456.7890', '2003-06-12',3,2500.00,101,1);

/*Inserindo os novos funcionarios ao departamento de inovações*/
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (215, 'William', 'Ferreira', 'will.ferr@momento.org','123.456.7890', '2022-11-05',20,4487.00,NULL,12);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (216, 'Fernanda', 'Lima', 'fernanda.lima@momento.org','123.456.7890', '2022-11-05',22,4487.00,NULL,12);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
VALUES (217, 'Fabiana', 'Raulino', 'fabi.raulino@momento.org','123.456.7890', '2022-11-05',21,4487.00,NULL,12);
...
/*Adicionando os dependentes de cada funcionario novo*/

/*dependentes do William*/
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,parentesco,funcionario_id) VALUES (35,'Inara','Ferreira','Conjuge',215);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,parentesco,funcionario_id) VALUES (34,'Gabriel', 'Ferreira', 'Filho(a)', 215);

/*dependentes da Fernanda*/
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,parentesco,funcionario_id) VALUES (36,'Rodrigo','Lime','Conjuge',216);

/*dependentes da Fabiana*/
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,parentesco,funcionario_id) VALUES (37,'Maya','Raulino','Filho(a)',217);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,parentesco,funcionario_id) VALUES (38,'Laura', 'Raulino', 'Filho(a)', 217);
